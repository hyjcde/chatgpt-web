<template>
	<div class="activation-code">
		<h1 style="color: rgba(244,239,239,0.8); font-size: 30px; margin-bottom: 20px;">Welcome to Jason's Chatroom</h1>
		<div class="card">
			<h2>Enter Activation Code</h2>
			<div class="input-group">
				<input type="password" v-model="inputCode" placeholder="Enter activation code" maxlength="8" />
